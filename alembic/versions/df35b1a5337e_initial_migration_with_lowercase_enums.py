"""initial_migration_with_lowercase_enums

Revision ID: df35b1a5337e
Revises: 
Create Date: 2025-05-28 10:40:54.329077
...
def upgrade() -> None:
    ...
    sa.Column('benefit_type', sa.Enum('content', 'cdkey', name='benefittype'), nullable=True),
    sa.Column('visibility', sa.Enum('public', 'private', name='benefitvisibility'), nullable=True),
    sa.Column('access_password', sa.String(length=255), nullable=True),
    sa.Column('mode', sa.Enum('normal', 'advanced', name='benefitmode'), nullable=True),
